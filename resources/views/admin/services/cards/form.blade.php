 <!--begin::Form-->
        ...
        <div class="form-group form-group-last col-sm-12">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-5 col-sm-12">
                    ...
                    <input type="text" name="name_en" id="name_en"  value=@if(!empty($subService))"{{$subService->name_en}}" @else"{{old('name_en')}}" @endif class="form-control"  placeholder="Enter Your English Name "/>
                ...
                <div class="form-group col-md-5 col-sm-12">
                    ...
                    <input type="text" name="name_ar"value=@if(!empty($subService))"{{$subService->name_ar}}"@else"{{old('name_ar')}}"@endif class="form-control"  placeholder="Enter Your Arabic Name "/>
            ...
            <div class="form-group col-sm-10">
                ...
                <textarea name="text_en" id="kt-ckeditor-1">
                    @if(!empty($subService)){{$subService->text_en}}@else{{old('text_en')}}@endif
                </textarea>
            ...
            <div class="form-group col-sm-10">
                ...
                <textarea name="text_ar" id="kt-ckeditor-2">
                     @if(!empty($subService)){{$subService->text_ar}}@else{{old('text_ar')}}@endif
                </textarea>
            ...
            <div class="form-group col-sm-10 m-auto">
                <label class="col-form-label" >@lang('newservices.images') <label class="text-danger">*</label> </label>
                <div style="width:80%;height: auto;">
                    <label for="upload-photo" cursor="pointer">
                        ...
                        <strong>not</strong>actually uploaded.</span>
                            ...
                            @else
                                <img id="output" width="200" height="150px" src="{{asset_public('image/'.$subService->images)}}" style="border-radius: 2%;" />
                            @endif
                        </div>
                    </label>
    ...
    <div class="card-footer col-sm-12 ">
        <input type="submit" id="submit" class="btn btn-primary mr-2" value="Add Card">
        <button type="reset" class="btn btn-secondary"><a href="{{route('admin.sub_service.index')}}">Cancel</a> </button>
    </div>
