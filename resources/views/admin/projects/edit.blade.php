                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item">
                                <a href="javascript:void(0)" class="text-muted">@lang('project.editproject')</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            <div class="card-header">
                                <h3 class="card-title">@lang('project.editproject')</h3>
                            </div>
...
$("i.del" ).on("click",function(e) {
    ...
    var recordID = $('#recordId').data('recordid');
      var imageId = $(this).parent().data('imagid');
      var image = $(this).parent().data('image');
    var updateUrl ="{{route('admin.projects.index')}}/imageDelete/"+recordID;
     $.ajax({
        url: updateUrl,
        method:"get",
        dataType: "json",
    ...
    console.log(recordID ,imageId ,image)
    $(this).parent().remove();
});
</script>
<script>
