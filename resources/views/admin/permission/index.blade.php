            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{route('admin.permissions.index')}}" class="text-muted">Permissions</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <label class="checkbox checkbox-single">
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    return `
                    @can('delete')
            <a href="/admin/permissions/${data}" class="btn btn-sm btn-clean btn-icon" title="Delete" onclick="event.preventDefault();
                ...
                <form id="delete-operator-form-${data}" action="/en/admin/permissions/${data}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
                    </form>
                </a>
