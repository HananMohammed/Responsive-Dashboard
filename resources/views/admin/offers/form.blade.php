        ...
        <div class="form-group form-group-last col-sm-12">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-5 col-sm-12">
                    <label>@lang('akwanoffers.name_en') <label class="text-danger">*</label> </label>
                    <input type="text" name="name_en" id="name_en"  value=@if(!empty($offer))"{{$offer->name_en}}" @else"{{old('name_en')}}" @endif class="form-control"  placeholder="Enter Your English Name "/>
                ...
                <div class="form-group col-md-5 col-sm-12">
                    <label>@lang('akwanoffers.name_ar') <label class="text-danger">*</label> </label>
                    <input type="text" name="name_ar"value=@if(!empty($offer))"{{$offer->name_ar}}"@else"{{old('name_ar')}}"@endif class="form-control"  placeholder="Enter Your Arabic Name "/>
            ...
            <div class="form-group col-sm-10">
                ...
                <input type="text" name="slug_en" id="slug" value=@if(!empty($offer))"{{$offer->slug_en}}"@else"{{old('slug_en')}}"@endif class="form-control" placeholder="Enter English Slug ">
                @if($errors->has('slug'))
                    <span class="error">{{ $errors->get('slug')[0] }}</span>
                @endif
            </div>
            <div class="form-group col-sm-10">
                <label>@lang('akwanoffers.text_en') <label class="text-danger">*</label>  </label>
                <textarea name="text_en" id="kt-ckeditor-1">
                    @if(!empty($offer)){{$offer->text_en}}@else{{old('text_en')}}@endif
                </textarea>
            ...
            <div class="form-group col-sm-10">
                <label>@lang('akwanoffers.text_ar') <label class="text-danger">*</label> </label>
                <textarea name="text_ar" id="kt-ckeditor-2">
                     @if(!empty($offer)){{$offer->text_ar}}@else{{old('text_ar')}}@endif
                </textarea>
            ...
            <div class="row">
                <div class="form-group col-lg-5 col-md-9 col-sm-12 text-lg-left" >
                    ...
                    <div style="width:80%;height: auto;">
                        ...
                        <strong>not</strong>actually uploaded.</span>
                                ...
                                @else
                                 <img id="output" width="200" height="150px" src="{{asset_public('image/'.$offer->images)}}" style="border-radius: 2%;" />
                                @endif
                            </div>
                        </label>
             ...
             <div class="form-group col-lg-5 col-md-9 col-sm-12" type="file" name="single_image">
                 ...
                 <div  style="width:80%;height: auto;">
                     <label for="upload-single-photo" style="cursor: pointer;" >
                        ...
                        <strong>not</strong>actually uploaded.</span>
                             ...
                             @else
                             <img id="outputSingleImage" width="200" src="{{asset_public('image/'.$offer->single_image)}}"  height="150px" style="border-radius: 2%;" />
                             @endif
                         </div>
                     </label>
                     <input type="file"  name="single_image" id="upload-single-photo"  onchange="loadFile(event)" hidden>
                     @if($errors->has('single_image'))
                         <span class="error">{{ $errors->get('single_image')[0] }}</span>
                     @endif
                 </div>
            </div>
            </div>

            @include('admin.offers.seo.index')
        </div>
    <div class="card-footer col-sm-12 ">
        @can('create')
        <input type="submit" id="submit" class="btn btn-primary mr-2" value="Add Offer">
        @endcan
        <button type="reset" class="btn btn-secondary"><a href="{{route('admin.offers.index')}}">Cancel</a> </button>
    </div>
